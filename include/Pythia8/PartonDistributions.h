...
public:
  ...
  EPAexternal(int idBeamIn, double m2In, PDFPtr gammaFluxPtrIn,
    ...
    bmhbarc(), xGridPositiveMin(), xGridPositiveMax(), approxMode(0), isLHA(false), gammaFluxPtr(gammaFluxPtrIn),
...
private:
  ...
  //Parche Alessio-Saray
  double xGridPositiveMin, xGridPositiveMax;
  
  int    approxMode;
  bool   isLHA;
  
  //parche Alessio-Saray implement
  vector<double> xGridApprox, fluxGridApprox, cdfGridApprox;
