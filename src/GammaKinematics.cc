...
double GammaKinematics::fluxWeight() {
  ...
  // Protect ratios against invalid values. Allesio-Saray PAtche
  auto safeFluxRatio = [](double numerator, double denominator) {
  ...
  // Done.
  return isfinite(wtFlux) ? wtFlux : 0.;
}
